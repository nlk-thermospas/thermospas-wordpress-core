...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html class="no-js" lang="en"><!--<![endif]-->
	<head>
		...
		<link href="<?php bloginfo('template_url'); ?>/bootstrap/css/app.css" rel="stylesheet">
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:900,700,300,600,400,400italic,700italic,900italic' rel='stylesheet' type='text/css'>
		...
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/bootstrap/js/jquery.scrollTo.min.js"></script>
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/bootstrap/js/jquery.localScroll.js"></script>
		<script type="text/javascript">
			...
			jQuery(document).ready(function(){
				...
				if(x >= 768)
				{
					jQuery('#bannerblock').css('height',y-80);
