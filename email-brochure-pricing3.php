...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html dir="ltr" lang="en-US" class="no-js"><!--<![endif]-->
  ...
  <head>
    ...
    <link rel="stylesheet" href="/email-brochure/email-brochure2.css">
...
<header role="main">
  ...
  <div id="inner-header" class="clearfix">
    ...
    <div id="logo" class="h1"><a href="" rel="nofollow"><img src="/email-brochure/images/logo_alt.png" alt="ThermoSpas" align="Thermospas"><span class="hidden">Thermospas</span></a></div>
                ...
                <div class="slide">
                  ...
                  <div id="subscribe_pricing">
                    ...
                    <div style="position: absolute; left: -100%; height: 1px; width: 1px; overflow: hidden;">
                      <input type="text" id="comments-hp" name="comments" placeholder="Please leave this field blank" autocomplete="off"/>
                    </div>
                    <div>
